...
// ===== CONSOLE MESSAGE =====
console.log('%c🛡️ Sparta Cursos', 'color: #1a237e; font-size: 24px; font-weight: bold;');
console.log('%cSua aprovação começa aqui!', 'color: #FFD700; font-size: 16px;');
console.log('%cDesenvolvido com ❤️', 'color: #DC143C; font-size: 14px;');
